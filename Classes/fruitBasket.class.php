...
class fruitBasket {
	...
	private $_inputFile,//@_inputFile: path to input file on server
			$_outputFile,//@_outputFile: path to output file if needed - we may allow direct downlaod when complete
	...
	public static function setOutput($filePath) {
		$this->_outputFile = $filePath;
	}

	public static function getOutput($filePath) {
		return $this->_outputFile;
	}	

	
	public function add_data_type($type) {
